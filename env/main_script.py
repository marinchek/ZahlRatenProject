...
low_phrases = [
    ...
    "Napoleon Dynamite would say, 'Lucky!' Your number is too low!",
    ...
    "To infinity and beyond... well, not quite with that guess! Your number is too low!",
...
high_phrases = [
    ...
    "The sky's the limit, but thats too high!",
